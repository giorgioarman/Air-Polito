...
class PmClass(object):
    ...
    def sensorData(self):
        ...
        self.cmd_set_working_period(PERIOD_CONTINUOUS)
        self.cmd_set_mode(MODE_QUERY);
        try:
            values= self.cmd_query_data()
            "Reading Data of sensor PM"
        except:
            print("PM Sensor: ERROR IN READING THE SENSOR")
